...
(function (global) {
  ...
  var DE = {
    ...
    // ── Mäxchen / Mia ──────────────────────────────────────────────────────
    "Mia": "Mäxchen",
    "Two dice under the hat. Beat the last claim — or lie. Get caught and you drink.":
      "Zwei Würfel unterm Hut. Überbiete die Ansage — oder lüge. Wer auffliegt, trinkt.",
    "How does it work?": "Wie geht's?",
    "Roll the two dice in secret, then announce a value HIGHER than the player before you — truth or bluff. When the hat reaches you, believe the claim and roll on, or lift the hat to call it. Lie that gets caught, or wrong accusation: lose a life. Ranking: 31…65, then doubles, then Mäxchen (21) on top.":
      "Würfle die zwei Würfel heimlich und sage dann einen Wert HÖHER als dein Vorgänger an — wahr oder gelogen. Bekommst du den Hut, glaubst du der Ansage und würfelst weiter, oder du hebst den Hut zum Aufdecken. Erwischte Lüge oder falscher Verdacht: ein Leben weg. Reihenfolge: 31…65, dann Päsche, dann Mäxchen (21) ganz oben.",
    "Lives per player": "Leben pro Spieler",
    "Start game ▶️": "Spiel starten ▶️",
    "Pass the hat": "Hut weitergeben",
    "On the table: {claim}": "Auf dem Tisch: {claim}",
    "You open the round — roll freely.": "Du eröffnest die Runde — würfle frei.",
    "I'm {name} — take the hat": "Ich bin {name} — Hut nehmen",
    "{who} claims {claim}": "{who} sagt {claim}",
    "{who} claims MÄXCHEN — unbeatable. You must lift the hat!":
      "{who} sagt MÄXCHEN — unschlagbar. Du musst den Hut heben!",
    "Lift the hat": "Hut heben",
    "Tap the hat to lift & call the bluff": "Tipp auf den Hut zum Aufdecken",
    "Believe it — roll on 🎲": "Glauben — weiterwürfeln 🎲",
    "Beat {claim} — or bluff.": "Überbiete {claim} — oder bluffe.",
    "Open the round with any claim.": "Eröffne die Runde mit beliebiger Ansage.",
    ...
    "Must beat {claim}": "Muss {claim} überbieten",
    "Opening claim — anything goes.": "Eröffnung — alles erlaubt.",
    "Announce…": "Ansagen…",
    "Lower": "Niedriger",
    "Higher": "Höher",
    "Say it & pass 🎩": "Ansagen & weitergeben 🎩",
    "the truth": "die Wahrheit",
    "a bluff (higher than your roll)": "geblufft (höher als dein Wurf)",
    "under your roll": "unter deinem Wurf",
    "It was TRUE — {who} really had it.": "Es war WAHR — {who} hatte es wirklich.",
    "BLUFF! {who} lied.": "BLUFF! {who} hat gelogen.",
    "drinks DOUBLE — Mäxchen!": "trinkt DOPPELT — Mäxchen!",
    "drinks!": "trinkt!",
    "loses 2 lives — Mäxchen!": "verliert 2 Leben — Mäxchen!",
    "loses a life.": "verliert ein Leben.",
    "{who} is out!": "{who} ist raus!",
    "Hat lifted!": "Hut gehoben!",
    "Claimed {claim} — ": "Angesagt {claim} — ",
    "See the winner 🏆": "Sieger zeigen 🏆",
    "last one standing — the bluff master!": "als Letzter übrig — der Bluff-Meister!",
    "Mäxchen": "Mäxchen",
    "Pasch": "Pasch",
  };
