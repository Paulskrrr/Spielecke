...
(function (global) {
  ...
  var DE = {
    ...
    "First make sure the Dials are set to their targets. <b>Channel</b> = Dial A + Dial B.": "Stell zuerst die Regler auf ihre Zielwerte. <b>Kanal</b> = Regler A + Regler B.",
    "If a wire's NUMBER equals the Channel, cut it. (If several match, the leftmost.)": "Hat ein Draht die ZAHL des Kanals, schneide ihn. (Bei mehreren der linkeste.)",
    "Otherwise, cut the wire whose COLOUR is highest on the Decoder's colour-priority list (1 = highest). Ties → leftmost.": "Sonst schneide den Draht, dessen FARBE in der Farb-Priorität des Decoders am höchsten steht (1 = höchste). Gleichstand → linkester.",
    "The cut reads the dials LIVE, so the dials must be right even if Wires comes first in the order.": "Der Schnitt liest die Regler LIVE — sie müssen also stimmen, auch wenn die Drähte zuerst dran sind.",
    ...
    "If indicator SIG is lit, press them in REVERSE order.": "Leuchtet die Anzeige SIG, drücke sie in UMGEKEHRTER Reihenfolge.",
    ...
    "Nine glyphs, scrambled. Press a sequence, then ✓.": "Neun Glyphen, gemischt. Drücke eine Folge, dann ✓.",
    "Ch. 1 — How to defuse": "Kapitel 1 — Entschärfung: Grundverfahren",
    "Ch. 2 — Data Protection (GDPR)": "Kap. 2 — Datenschutz (DSGVO)",
    "Ch. 3 — Firing order": "Kap. 3 — Zünd-Reihenfolge",
    "Ch. 4 — Dials": "Kap. 4 — Regler",
    "Ch. 5 — Wires": "Kap. 5 — Drähte",
    "Ch. 6 — Warranty & Liability": "Kap. 6 — Garantie & Haftung",
    "Ch. 7 — Keypad": "Kap. 7 — Tastenfeld",
    "Ch. 8 — Reading the bomb": "Kap. 8 — Die Bombe lesen",
    ...
    "Set both dials to their target values and add them together to read the channel.": "Stelle beide Regler auf ihre Zielwerte und addiere sie zum Kanal.",
    "Locate the wire whose printed number equals the channel; that is the wire to cut.": "Finde den Draht, dessen aufgedruckte Zahl dem Kanal entspricht; dieser Draht wird geschnitten.",
    "If no number matches, use the colour-priority order: cut the highest-ranked colour present.": "Passt keine Zahl, nutze die Farb-Priorität: schneide die höchstplatzierte vorhandene Farbe.",
    "Confirm the cut against the firing order before severing the wire.": "Gleiche den Schnitt mit der Zünd-Reihenfolge ab, bevor du den Draht durchtrennst.",
    ...
    "The keypad uses a non-standard glyph set for tamper resistance; positions are randomised per unit. Identify glyphs by shape, not location.": "Das Tastenfeld nutzt einen nicht standardisierten Glyphensatz zum Manipulationsschutz; die Positionen sind je Gerät zufällig. Erkenne Glyphen an der Form, nicht am Ort.",
