...
(function (global) {
  ...
  var DE = {
    ...
    "Pump as many sips into the pot as you dare, then pass. The balloon pops on a hidden pump — hold it then and you drink the pot.": "Pump so viele Schlücke in den Pot, wie du dich traust, dann weitergeben. Der Ballon platzt bei einem versteckten Pump — wer ihn dann hält, trinkt den Pot.",
    ...
    "Everyone else bets sips on whether they pull it off.": "Alle anderen setzen Schlücke, ob er/sie es schafft.",
    ...
    "Lock bets & go ▶️": "Wetten fix & los ▶️",
    ...
    "Say a new word together each round. Tap +1 every time you miss.": "Sagt jede Runde gleichzeitig ein neues Wort. Tippt +1, wenn ihr euch verfehlt.",
    ...
    "A secret mission, all night long. Pull it off before you're caught.": "Ein Geheimauftrag, den ganzen Abend. Zieh ihn durch, bevor du auffliegst.",
    "Everyone gets a secret task tied to one specific person. Keep playing other games — sneak yours in. Come back here to peek, cash in, or accuse.": "Jeder bekommt eine geheime Aufgabe, gebunden an eine bestimmte Person. Spielt andere Spiele weiter — und schmuggelt deine ein. Komm hierher zurück zum Spähen, Einlösen oder Anklagen.",
    ...
    "Was {name} really caught in the act?": "Wurde {name} wirklich auf frischer Tat ertappt?",
    "Caught! They drink 🍺": "Ertappt! Er/Sie trinkt 🍺",
    "False alarm — accuser drinks": "Fehlalarm — der Ankläger trinkt",
    "Busted!": "Erwischt!",
    "{names} are burned — both drink and draw fresh missions.": "{names} sind verbrannt — beide trinken und ziehen neue Aufträge.",
    "{names} drinks and draws a fresh mission.": "{names} trinkt und zieht einen neuen Auftrag.",
    "False alarm": "Fehlalarm",
    "The accuser drinks. Missions stay secret.": "Der Ankläger trinkt. Die Aufträge bleiben geheim.",
    ...
    "Shows prompt, czar & code": "Zeigt Prompt, Czar & Code",
