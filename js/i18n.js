...
(function (global) {
  ...
  var DE = {
    ...
    "A wrong action, or acting out of order, is a strike. Three strikes — or the clock hitting zero — and it blows.": "Eine falsche Aktion oder die falsche Reihenfolge ist ein Fehler. Drei Fehler — oder die Uhr auf null — und sie geht hoch.",
    ...
    "Abort": "Abbrechen",
    "Three jobs live on the device: <b>Wires</b>, <b>Keypad</b>, <b>Dials</b>. They must be committed in the right ORDER — see Firing Order.": "Drei Aufgaben stecken im Gerät: <b>Drähte</b>, <b>Tastenfeld</b>, <b>Regler</b>. Sie müssen in der richtigen REIHENFOLGE bestätigt werden — siehe Zünd-Reihenfolge.",
    "Every job reads values off OTHER faces. The defuser can't read this manual and you can't see the bomb — so make them flip the cube around and describe what they see.": "Jede Aufgabe nutzt Werte von ANDEREN Seiten. Der Entschärfer kann dieses Handbuch nicht lesen und du siehst die Bombe nicht — lass ihn also den Würfel drehen und beschreiben, was er sieht.",
    "One face shows three sigils in a row. Translate each to a job, left to right — that's the order to commit them in.": "Eine Seite zeigt drei Sigillen in einer Reihe. Übersetze jede in eine Aufgabe, von links nach rechts — das ist die Reihenfolge zum Bestätigen.",
    "Nine glyphs, scrambled. Press a sequence, then ✓.": "Neun Glyphen, gemischt. Drücke eine Folge, dann ✓.",
    "Ch. 1 — How to defuse": "Kap. 1 — So entschärfst du",
    ...
    "Ch. 2 — Firing order": "Kap. 2 — Zünd-Reihenfolge",
    ...
    "Read each instruction aloud and confirm it with the operator before it is carried out. Retain this manual for the duration of the engagement.": "Lies jede Anweisung laut vor und bestätige sie mit dem Bediener, bevor sie ausgeführt wird. Bewahre dieses Handbuch für die Dauer des Einsatzes auf.",
    "The firing sequence is fixed at manufacture and cannot be reordered in the field.": "Die Zündreihenfolge ist werkseitig festgelegt und kann im Feld nicht geändert werden.",
    "Note: committing a stage out of sequence is logged as a fault and cannot be undone.": "Hinweis: Eine Stufe außer der Reihe zu bestätigen wird als Fehler protokolliert und kann nicht rückgängig gemacht werden.",
