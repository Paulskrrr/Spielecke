...
(function (global) {
  ...
  var DE = {
    ...
    "Know Me": "Kennst du mich?",
    "Answer as they would. Whoever knows the group best wins.": "Antworte so, wie sie antworten würden. Wer die anderen am besten kennt, gewinnt.",
    "Freehand the shape. The maths decides who actually nailed it.": "Form freihand zeichnen. Die Mathematik entscheidet, wer sie wirklich trifft.",
    ...
    "Random": "Zufällig",
    "🎲 Random keeps the count secret — even the imposters won't know how many. Bigger tables, more fakers.": "🎲 Zufällig hält die Anzahl geheim — nicht mal die Imposter wissen, wie viele es sind. Größere Runden, mehr Betrüger.",
    ...
    "You might not be the only faker — but you'll never know how many.": "Vielleicht bist du nicht der einzige Betrüger — aber du erfährst nie, wie viele.",
    ...
    // ── Perfect Shape ──────────────────────────────────────────────────────
    "Turn order ({n}): {names}": "Reihenfolge ({n}): {names}",
    "Everyone draws the same shape freehand. Position and size don't matter — only the shape does.": "Alle zeichnen dieselbe Form freihand. Wo und wie groß ist egal — nur die Form zählt.",
    "Difficulty": "Schwierigkeit",
    "⏱️ Time pressure ({n}s)": "⏱️ Zeitdruck ({n}s)",
    "🙈 Hardcore: hide the reference": "🙈 Hardcore: Vorlage ausblenden",
    ...
    "Next shape 🔁": "Nächste Form 🔁",
    "That's not a hand, that's a printer.": "Das ist keine Hand, das ist ein Drucker.",
    "Suspiciously clean.": "Verdächtig sauber.",
    "Solid. The hand knew what it wanted.": "Stark. Die Hand wusste, was sie wollte.",
    "Good enough to win this table.": "Reicht, um diesen Tisch zu schlagen.",
    "Won the round. Let's not frame it.": "Runde gewonnen. Aufhängen muss man es nicht.",
    "Somebody had to win.": "Irgendjemand musste ja gewinnen.",

    // ── Know Me ────────────────────────────────────────────────────────────
    "A question about one of you goes to somebody else. Answer it the way they would — they decide if you nailed it.": "Eine Frage über einen von euch geht an jemand anderen. Antworte so, wie diese Person es tun würde — sie löst auf.",
    "Points to win": "Punkte zum Sieg",
    "🍻 Drinking mode (miss = you drink, hit = they drink)": "🍻 Trinkspiel (daneben = du trinkst, Treffer = sie trinken)",
    "Question about {name}": "Frage über {name}",
    "{name}, answer the way {subject} would — out loud.": "{name}, antworte so, wie {subject} es tun würde — laut.",
    "{name} tells the truth — did {guesser} get it?": "{name} löst auf — hat {guesser} es getroffen?",
    "Reveal 👀": "Auflösen 👀",
    "Dead on ✅": "Getroffen ✅",
    "Not a chance ❌": "Daneben ❌",
    "Dead on!": "Getroffen!",
    "Not a chance!": "Daneben!",
    "+1 for {name}": "+1 für {name}",
    "−1 for {name}": "−1 für {name}",
    "🍺 {name} drinks — far too predictable.": "🍺 {name} trinkt — viel zu durchschaubar.",
    "🍺 {name} drinks.": "🍺 {name} trinkt.",
    "{name} knows this group better than anyone.": "{name} kennt diese Runde besser als alle anderen.",
    "Standings": "Punktestand",
    "first to {n}": "wer zuerst {n} hat",
    ...
    "Secretly set a timer on this phone. When it runs out, whoever is speaking drinks. Don't let others watch.": "Stell heimlich einen Timer auf diesem Handy. Läuft er ab, dient, wer gerade spricht. Die anderen sollen nicht zusehen.",
    ...
    "Driver": "Busfahrer",
    "No players yet — add some from the header (👥) to rotate the driver, or just pass the phone.": "Noch keine Spieler — oben (👥) welche hinzufügen, um den Busfahrer reihum zu wechseln, oder einfach das Handy weiterreichen.",
    ...
    "Which suit exactly?": "Welche Farbe genau?",
    "🔴 Red": "🔴 Rot",
    "⚫️ Black": "⚫️ Schwarz",
    "⬆️ Higher": "⬆️ Höher",
    "⬇️ Lower": "⬇️ Tiefer",
    ...
    "cleared all four — hand out the {n} sips you collected!": "alle vier geschafft — verteile die {n} gesammelten Schlücke!",
    "cleared all four on the first try — no sips to hand out. The bus rolls on.": "alle vier auf Anhieb geschafft — keine Schlücke zum Verteilen. Der Bus rollt weiter.",
    "cleared all four — no drinks. The bus rolls on.": "alle vier geschafft — keine Schlücke. Der Bus rollt weiter.",
    "Next driver ▶️": "Nächster Busfahrer ▶️",
    ...
    "Simon Says": "Kommando",
    "BETA": "BETA",
    "Do what Simon says — never what he doesn't. Slip up and you drink.": "Führ jedes Kommando aus — aber nichts, was ohne „Kommando“ kommt. Patzer? Trinken.",
    ...
    "Last one standing — Simon's favourite!": "Als Letzter übrig — Kommando standhaft befolgt!",
    "Simon says:": "Kommando:",
    ...
    // ── Lügen / Cheat (Beta) ────────────────────────────────────────────────
    "Cheat": "Lügen",
    "Dump your cards, lie about them. Get caught and eat the pile.": "Karten abwerfen, dreist lügen. Wirst du ertappt, frisst du den Stapel.",
    "The whole deck is dealt out. On your turn you must claim a set rank (the leader picks it, then it climbs by one each turn) — but you play your cards face down, so you can lie. Anyone can shout „Lüge!\": the cards flip, and whoever was wrong — the liar or the accuser — takes the whole pile. First to empty their hand wins. Your last card is the riskiest.":
      "Das ganze Deck wird ausgeteilt. Wenn du dran bist, musst du einen festen Rang ansagen (der Erste wählt ihn, danach steigt er jede Runde um eins) — aber du legst verdeckt, also darfst du lügen. Jeder darf „Lüge!\" rufen: die Karten werden aufgedeckt, und wer falsch lag — Lügner oder Ankläger — nimmt den ganzen Stapel. Wer zuerst keine Karten mehr hat, gewinnt. Deine letzte Karte ist am riskantesten.",
    "Deck": "Deck",
    "Short (32)": "Kurz (32)",
    "Full (52)": "Voll (52)",
    "Deal 🤥": "Austeilen 🤥",
    "New pile — {name} leads": "Neuer Stapel — {name} eröffnet",
    "Claim due: {rank}": "Anzusagen: {rank}",
    "Only {name} looks at the hand.": "Nur {name} schaut auf die Hand.",
    "I'm {name} — my hand": "Ich bin {name} — meine Hand",
    "{n} cards": "{n} Karten",
    "Announce which rank:": "Welchen Rang ansagen:",
    "You must claim:": "Du musst ansagen:",
    "Tap up to {k} cards to lay face down — truth or bluff.": "Tippe bis zu {k} Karten an, um sie verdeckt zu legen — Wahrheit oder Bluff.",
    "Lay face down": "Verdeckt legen",
    "Lay {k} face down": "{k} verdeckt legen",
    "You open the pile.": "Du eröffnest den Stapel.",
    "{n} cards face down in the pile.": "{n} Karten verdeckt im Stapel.",
    "lays face down and claims": "legt verdeckt und sagt an",
    "Their LAST cards!": "Ihre LETZTEN Karten!",
    "Pile: {n}": "Stapel: {n}",
    "Believe — next ▶️": "Glauben — weiter ▶️",
    "Call „Lüge!\" 🔍": "„Lüge!\" rufen 🔍",
    "Who calls „Lüge!\"?": "Wer ruft „Lüge!\"?",
    "{name} claimed {n} × {rank}.": "{name} sagte {n} × {rank} an.",
    "Never mind — believe": "Doch nicht — glauben",
    "Claim: {n} × {rank}": "Ansage: {n} × {rank}",
    "No lie! {name} was telling the truth.": "Keine Lüge! {name} hat die Wahrheit gesagt.",
    "Busted — {name} lied!": "Ertappt — {name} hat gelogen!",
    "{name} takes the pile ({n} cards)": "{name} nimmt den Stapel ({n} Karten)",
    "{n} sips": "{n} Schlücke",
    "Play on ▶️": "Weiter geht's ▶️",
    "{name} is out — and wins!": "{name} ist raus — und gewinnt!",
    "Deal again 🔁": "Neu austeilen 🔁",
  };
