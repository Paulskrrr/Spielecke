...
(function (global) {
  ...
  var DE = {
    ...
    "A wrong action, or acting out of order, is a strike. Three strikes — or the clock hitting zero — and it blows.": "Jede Fehlbedienung sowie jede Abweichung von der Reihenfolge gilt als Fehlversuch. Nach dem dritten Fehlversuch — oder bei Ablauf der Uhr — erfolgt die Auslösung.",
    "The Core face shows three sigils. Translate each to a job, left to right — that's the order to solve them in.": "Die Kern-Seite zeigt drei Sigillen. Übersetze jede in eine Aufgabe, von links nach rechts — das ist die Reihenfolge.",
    "Sigil": "Sigille",
    "Job": "Baugruppe",
    "If the LAST digit of the serial is EVEN, reverse the order (read the sigils right to left).": "Ist die LETZTE Ziffer der Seriennummer gerade, kehrt sich die Reihenfolge um; die Sigillen sind dann von rechts nach links zu lesen.",
    ...
    "Abort": "Abbrechen",
    "Three jobs live on the device: <b>Wires</b>, <b>Keypad</b>, <b>Dials</b>. They must be committed in the right ORDER — see Firing Order.": "Der Zünder umfasst drei Baugruppen: <b>Drähte</b>, <b>Tastenfeld</b> und <b>Regler</b>. Sie sind ausnahmslos in der vorgeschriebenen Reihenfolge abzuarbeiten (siehe Zünd-Reihenfolge).",
    "Every job reads values off OTHER faces. The defuser can't read this manual and you can't see the bomb — so make them flip the cube around and describe what they see.": "Jede Baugruppe erfordert Werte, die auf ANDEREN Gehäuseseiten angebracht sind. Da dem Bediener am Zünder dieses Handbuch nicht vorliegt und der Zünder dem Leser nicht zugänglich ist, ist der Bediener anzuweisen, das Gehäuse zu drehen und den sichtbaren Befund vollständig anzusagen.",
    "One face shows three sigils in a row. Translate each to a job, left to right — that's the order to commit them in.": "Eine Gehäuseseite trägt drei Sigillen in einer Reihe. Jede ist — von links nach rechts — in die zugehörige Baugruppe zu übersetzen; die daraus entstehende Folge gibt die Abarbeitungsreihenfolge vor.",
    ...
    "Read each instruction aloud and confirm it with the operator before it is carried out. Retain this manual for the duration of the engagement.": "Jede Anweisung ist vor der Ausführung laut vorzulesen und mit dem Bediener abzugleichen. Das Handbuch ist während des gesamten Einsatzes bereitzuhalten.",
    ...
    "Note: committing a stage out of sequence is logged as a fault and cannot be undone.": "Hinweis: Das Bestätigen einer Baugruppe außerhalb der vorgesehenen Reihenfolge wird als Fehler protokolliert und ist nicht rückgängig zu machen.",
    ...
    "Do not operate while drowsy, intoxicated, or panicking. (The operator acknowledges the last may be unavoidable.)": "Nicht bedienen, wenn schläfrig, betrunken oder in Panik. (Der Bediener erkennt an, dass Letzteres unvermeidbar sein kann.)",
