    ...
    de: {
      ...
      starwars: {
        ...
        pairs: [
          ...
          { left: "Feigling der Rebellion", right: "Kriegsheld der Rebellion" },
          { left: "Nutzloser Droide", right: "Rettet die ganze Mission" },
          { left: "Rostige Klapperkiste", right: "Schnellstes Schiff der Galaxis" },
          { left: "Öder Wüstenplanet", right: "Pulsierendes Galaxiszentrum" },
          { left: "Vergessene Randfigur", right: "Trägt die ganze Saga" },
          { left: "Frisch von der Farm", right: "Auserwählter der Prophezeiung" },
          { left: "Versauter Sith-Lehrling", right: "Perfekter dunkler Meister" },
          { left: "Lahmes Lichtschwertduell", right: "Bestes Duell aller Zeiten" },
          { left: "Merch, den keiner will", right: "Muss-haben-Sammlerstück" },
          { left: "Klon von der Stange", right: "Einzigartiger Krieger" },
        ],
      },
      minecraft: {
        label: "⛏️ Minecraft",
    ...
    en: {
      ...
      starwars: {
        ...
        pairs: [
          ...
          { left: "Rebellion coward", right: "Rebellion war hero" },
          { left: "Useless droid", right: "Saves the whole mission" },
          { left: "Rusty piece of junk", right: "Fastest ship in the galaxy" },
          { left: "Dull desert planet", right: "Buzzing galactic capital" },
          { left: "Forgotten side character", right: "Carries the whole saga" },
          { left: "Fresh off the farm", right: "Chosen one of prophecy" },
          { left: "Botched Sith apprentice", right: "Perfect dark-side pupil" },
          { left: "Lame lightsaber duel", right: "Greatest duel of all time" },
          { left: "Merch nobody wants", right: "Must-have collector's item" },
          { left: "Off-the-rack clone", right: "One-of-a-kind warrior" },
        ],
      },
      minecraft: {
        label: "⛏️ Minecraft",
