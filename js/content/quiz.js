    ...
    mcgregor: {
      ...
      levels: [
        ...
        [
          ...
          { q: "McGregor's huge rivalry is with which undefeated Russian fighter?", options: ["Khabib Nurmagomedov", "Islam Makhachev", "Fedor Emelianenko", "Alexander Volkanovski"], answer: 0 },
          { q: "Which fighter handed McGregor his first UFC loss?", options: ["Nate Diaz", "Khabib Nurmagomedov", "Dustin Poirier", "Floyd Mayweather"], answer: 0 },
          ...
          { q: "In 2026 McGregor returned at UFC 329 to fight whom after ~5 years away?", options: ["Max Holloway", "Dustin Poirier", "Michael Chandler", "Khabib Nurmagomedov"], answer: 0 },
        ],
        ...
        [
          ...
          { q: "McGregor's first UFC loss (to Nate Diaz) came by what method?", options: ["Rear-naked choke", "Knockout", "Decision", "Armbar"], answer: 0 },
          ...
          { q: "McGregor won the UFC lightweight title by KO of whom at UFC 205?", options: ["Eddie Alvarez", "Rafael dos Anjos", "Khabib Nurmagomedov", "Dustin Poirier"], answer: 0 },
          { q: "How did McGregor's boxing match with Floyd Mayweather end?", options: ["10th-round TKO loss", "Points win", "1st-round KO loss", "Draw"], answer: 0 },
          { q: "At UFC 229, Khabib Nurmagomedov beat McGregor by what?", options: ["Submission", "Knockout", "Unanimous decision", "Disqualification"], answer: 0 },
          ...
          { q: "McGregor suffered his first MMA KO/TKO loss in the 2021 rematch with whom?", options: ["Dustin Poirier", "Nate Diaz", "Khabib Nurmagomedov", "Eddie Alvarez"], answer: 0 },
          { q: "In the July 2021 Poirier trilogy fight, how did McGregor lose?", options: ["Broke his leg (doctor stoppage)", "Rear-naked choke", "Knockout punch", "On points"], answer: 0 },
          { q: "McGregor was stripped of the UFC lightweight title in 2018 for what?", options: ["Inactivity", "A failed drug test", "Missing weight", "Retiring"], answer: 0 },
        ...
        [
          ...
          { q: "McGregor's first loss to Nate Diaz came in which round?", options: ["Round 2", "Round 1", "Round 3", "Round 4"], answer: 0 },
          { q: "McGregor's KO of Eddie Alvarez came in which round?", options: ["Round 2", "Round 1", "Round 3", "Round 4"], answer: 0 },
          { q: "McGregor's loss to Khabib came by neck crank in which round?", options: ["Round 4", "Round 2", "Round 3", "Round 5"], answer: 0 },
          ...
          { q: "McGregor's UFC 257 loss to Poirier came in which round?", options: ["Round 2", "Round 1", "Round 3", "Round 4"], answer: 0 },
          { q: "In the Poirier trilogy fight, the doctor stoppage came after which round (McGregor broke his leg)?", options: ["Round 1", "Round 2", "Round 3", "Round 4"], answer: 0 },
          ...
          { q: "In November 2024, a Dublin civil court found McGregor liable for what?", options: ["Assault", "Fraud", "Defamation", "Tax evasion"], answer: 0 },
          { q: "McGregor was ordered to pay roughly how much in damages in that case?", options: ["€250,000", "€50,000", "€1 million", "€25,000"], answer: 0 },
          { q: "After the 2024 verdict, which company removed McGregor's name from Proper No. Twelve?", options: ["Proximo", "Diageo", "Pernod Ricard", "Bacardi"], answer: 0 },
          ...
          { q: "After which fight did a mass post-fight brawl draw Nevada commission penalties?", options: ["UFC 229 (Khabib)", "UFC 202 (Diaz)", "UFC 205 (Alvarez)", "UFC 246 (Cerrone)"], answer: 0 },
          ...
          { q: "McGregor's 'red panty night' line (2015) was aimed at which fighter?", options: ["Rafael dos Anjos", "Eddie Alvarez", "Khabib Nurmagomedov", "Nate Diaz"], answer: 0 },
    ...
    mcgregor: {
      ...
      levels: [
        ...
        [
          ...
          { q: "McGregors größte Rivalität besteht mit welchem ungeschlagenen russischen Kämpfer?", options: ["Khabib Nurmagomedov", "Islam Makhachev", "Fedor Emelianenko", "Alexander Volkanovski"], answer: 0 },
          { q: "Welcher Kämpfer fügte McGregor seine erste UFC-Niederlage zu?", options: ["Nate Diaz", "Khabib Nurmagomedov", "Dustin Poirier", "Floyd Mayweather"], answer: 0 },
          ...
          { q: "2026 kehrte McGregor bei UFC 329 gegen wen zurück — nach rund 5 Jahren Pause?", options: ["Max Holloway", "Dustin Poirier", "Michael Chandler", "Khabib Nurmagomedov"], answer: 0 },
        ],
        ...
        [
          ...
          { q: "McGregors erste UFC-Niederlage (gegen Nate Diaz) kam durch welche Methode?", options: ["Rear-Naked-Choke", "Knockout", "Punktentscheid", "Armhebel"], answer: 0 },
          ...
          { q: "McGregor gewann den UFC-Leichtgewichtstitel per K.o. gegen wen bei UFC 205?", options: ["Eddie Alvarez", "Rafael dos Anjos", "Khabib Nurmagomedov", "Dustin Poirier"], answer: 0 },
          { q: "Wie endete McGregors Boxkampf gegen Floyd Mayweather?", options: ["TKO-Niederlage in Runde 10", "Punktsieg", "K.o.-Niederlage in Runde 1", "Unentschieden"], answer: 0 },
          { q: "Bei UFC 229 besiegte Khabib Nurmagomedov McGregor wodurch?", options: ["Submission", "Knockout", "Einstimmiger Punktentscheid", "Disqualifikation"], answer: 0 },
          ...
          { q: "McGregor kassierte seine erste MMA-K.o./TKO-Niederlage 2021 im Rückkampf gegen wen?", options: ["Dustin Poirier", "Nate Diaz", "Khabib Nurmagomedov", "Eddie Alvarez"], answer: 0 },
          { q: "Wie verlor McGregor im Poirier-Trilogie-Kampf im Juli 2021?", options: ["Beinbruch (Arztabbruch)", "Rear-Naked-Choke", "K.o.-Schlag", "Nach Punkten"], answer: 0 },
          { q: "McGregor wurde 2018 der UFC-Leichtgewichtstitel aberkannt — weshalb?", options: ["Inaktivität", "Positive Dopingprobe", "Gewicht verfehlt", "Rücktritt"], answer: 0 },
        ...
        [
          ...
          { q: "McGregors erste Niederlage gegen Nate Diaz fiel in welcher Runde?", options: ["Runde 2", "Runde 1", "Runde 3", "Runde 4"], answer: 0 },
          { q: "McGregors K.o. gegen Eddie Alvarez fiel in welcher Runde?", options: ["Runde 2", "Runde 1", "Runde 3", "Runde 4"], answer: 0 },
          { q: "McGregors Niederlage gegen Khabib per Neck Crank fiel in welcher Runde?", options: ["Runde 4", "Runde 2", "Runde 3", "Runde 5"], answer: 0 },
          ...
          { q: "McGregors Niederlage gegen Poirier bei UFC 257 fiel in welcher Runde?", options: ["Runde 2", "Runde 1", "Runde 3", "Runde 4"], answer: 0 },
          { q: "Im Poirier-Trilogie-Kampf kam der Arztabbruch nach welcher Runde (McGregor brach sich das Bein)?", options: ["Runde 1", "Runde 2", "Runde 3", "Runde 4"], answer: 0 },
          ...
          { q: "Im November 2024 befand ein Dubliner Zivilgericht McGregor wofür haftbar?", options: ["Körperverletzung", "Betrug", "Verleumdung", "Steuerhinterziehung"], answer: 0 },
          { q: "McGregor wurde zu ungefähr welcher Schadensersatzsumme verurteilt?", options: ["250.000 €", "50.000 €", "1 Mio. €", "25.000 €"], answer: 0 },
          { q: "Nach dem Urteil 2024 entfernte welches Unternehmen McGregors Namen von Proper No. Twelve?", options: ["Proximo", "Diageo", "Pernod Ricard", "Bacardi"], answer: 0 },
          ...
          { q: "Nach welchem Kampf brachte eine Massenschlägerei Strafen der Nevada-Kommission?", options: ["UFC 229 (Khabib)", "UFC 202 (Diaz)", "UFC 205 (Alvarez)", "UFC 246 (Cerrone)"], answer: 0 },
          ...
          { q: "McGregors 'red panty night'-Spruch (2015) war an welchen Kämpfer gerichtet?", options: ["Rafael dos Anjos", "Eddie Alvarez", "Khabib Nurmagomedov", "Nate Diaz"], answer: 0 },
