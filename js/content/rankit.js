    ...
    de: {
      ...
      party: {
        ...
        sets: [
          ...
          { title: "Bester → schlechtester Vorglüh-Drink", items: ["Aperol Spritz", "Bier", "Wodka-Mische", "Glühwein", "Lauwarmer Sekt"] },
          { title: "Größtes → kleinstes Zeichen, dass du zu betrunken bist", items: ["Auf dem Boden sitzen", "Allen deine Liebe gestehen", "Doppelt sehen", "Viel zu laut reden", "Schon wieder Kebab bestellen"] },
          { title: "Beste → schlechteste Person, um mit ihr heimzukommen", items: ["Der nüchterne Freund", "Der mit dem Auto", "Der Taxi-Bezahler", "Der, der auch dicht ist", "Der, der unbedingt weiterziehen will"] },
          { title: "Legendärste → peinlichste Tanzflächen-Aktion", items: ["Der Moonwalk", "Luftgitarre", "Der Sprung in die Menge", "Twerken an der Box", "Einfach hinfallen"] },
          { title: "Beste → schlechteste Afterparty-Location", items: ["Bei jemandem zuhause", "Am See", "Im Park", "Auf dem Parkplatz", "An der Tankstelle"] },
          { title: "Größter → kleinster Partyheld", items: ["Der DJ", "Der mit dem Nachschub", "Der Gastgeber", "Der den Türsteher kennt", "Der, der danach aufräumt"] },
          { title: "Bester → schlechtester Shot", items: ["Tequila", "Jägermeister", "Sambuca", "Wodka", "Selbstgemachter Mystery-Shot"] },
          { title: "Größtes → kleinstes WG-Party-Drama", items: ["Die Polizei kommt", "Nachbarn beschweren sich", "Jemand kotzt aufs Sofa", "Der Alkohol ist alle", "Die Playlist wird gekapert"] },
          { title: "Wahrscheinlichster → unwahrscheinlichster, der bis Sonnenaufgang wach ist", items: ["Das Energiebündel", "Der Kaffee-Junkie", "Der ruhige Typ", "Der Frühschläfer", "Der, der sich 'nur kurz' hinlegt"] },
          ...
          { title: "Coolster → cringigster Partytrick", items: ["Flasche mit Feuerzeug öffnen", "Kartentrick", "Beatboxen", "Bauchreden", "Witze, die keiner checkt"] },
          { title: "Beste → schlechteste Ausrede, früher zu gehen", items: ["Muss morgen früh raus", "Babysitter wartet", "Hund muss raus", "Bin einfach müde", "Heimlich ohne Bescheid abhauen"] },
          { title: "Größte → kleinste Gefahr auf einer Hausparty", items: ["Die Treppe", "Der Pool", "Der Grill", "Die weißen Möbel", "Der Wackelkontakt der Anlage"] },
          { title: "Bester → schlechtester Bier-Pong-Partner", items: ["Der Treffsichere", "Der Glückspilz", "Der Trash-Talker", "Der mit der Zitterhand", "Der schon viel zu Betrunkene"] },
          { title: "Bestes → schlechtestes Katerfrühstück", items: ["Rührei mit Speck", "Döner", "Pizza von gestern", "Grüner Smoothie", "Noch ein Bier"] },
        ],
      },
      videogames: {
        label: "🎮 Videospiele",
    ...
    en: {
      ...
      party: {
        ...
        sets: [
          ...
          { title: "Best → worst pre-game drink", items: ["Aperol Spritz", "Beer", "Vodka mixer", "Mulled wine", "Warm prosecco"] },
          { title: "Biggest → smallest sign you're too drunk", items: ["Sitting on the floor", "Confessing your love to everyone", "Seeing double", "Talking way too loud", "Ordering yet another kebab"] },
          { title: "Best → worst person to get home with", items: ["The sober friend", "The one with a car", "The one who pays for the taxi", "The one who's also wasted", "The one who insists on going on"] },
          { title: "Most legendary → most embarrassing dance-floor move", items: ["The moonwalk", "Air guitar", "Jumping into the crowd", "Twerking on the speaker", "Just falling over"] },
          { title: "Best → worst afterparty spot", items: ["Someone's place", "By the lake", "In the park", "The car park", "The petrol station"] },
          { title: "Biggest → smallest party hero", items: ["The DJ", "The one with the refills", "The host", "The one who knows the bouncer", "The one who cleans up after"] },
          { title: "Best → worst shot", items: ["Tequila", "Jägermeister", "Sambuca", "Vodka", "A homemade mystery shot"] },
          { title: "Biggest → smallest house-party drama", items: ["The police show up", "Neighbours complain", "Someone throws up on the sofa", "The booze runs out", "The playlist gets hijacked"] },
          { title: "Most → least likely to still be awake at sunrise", items: ["The ball of energy", "The caffeine junkie", "The quiet one", "The early sleeper", "The one who 'just lies down for a sec'"] },
          { title: "Best → worst reason to buy a round", items: ["A birthday", "A promotion", "Surviving a breakup", "Just because", "Out of guilt"] },
          { title: "Coolest → most cringe party trick", items: ["Opening a bottle with a lighter", "A card trick", "Beatboxing", "Ventriloquism", "Jokes nobody gets"] },
          { title: "Best → worst excuse to leave early", items: ["Early start tomorrow", "The babysitter's waiting", "Gotta walk the dog", "Just tired", "Sneaking off without a word"] },
          { title: "Biggest → smallest hazard at a house party", items: ["The stairs", "The pool", "The barbecue", "The white furniture", "The dodgy speaker connection"] },
          { title: "Best → worst beer-pong teammate", items: ["The sharpshooter", "The lucky one", "The trash-talker", "The shaky-handed one", "The already-way-too-drunk one"] },
          { title: "Best → worst hangover breakfast", items: ["Bacon and eggs", "A kebab", "Yesterday's pizza", "A green smoothie", "Another beer"] },
        ],
      },
      videogames: {
        label: "🎮 Video Games",
