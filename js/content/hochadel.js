 ...
 *              the table (default 1) instead of lasting until game's end. MOST
 *              rule cards should carry this — Hofgesetze that never expire stack up
 *              fast and become impossible to track by the second half of a game.
 *              Leave a card permanent only when it's explicitly designed to last
 *              (its text says "bis Spielende" / "for life") and is low-friction to
 *              remember. The card text must say how long it lasts ("eine Runde
 *              lang", "zwei Runden lang") so players know it's temporary.
...
(function (global) {
  ...
  var DECK_DE = [
    ...
    { id: "s_thronwechsel", type: "sofort", title: "Der Thronwechsel",
      text: "{P} tauscht den Sitzplatz mit einer Person der Wahl. Wer weichen muss, dient als Trost.",
      editions: ["koenige", "rapunzel"] },
    ...
    { id: "r_anrede", type: "regel", title: "Höfische Anrede",
      text: "Eine Runde lang siezt sich der gesamte Hof. Verstoß = dienen.", editions: ["koenige", "rapunzel"], temp: true },
    ...
    { id: "s_ex_immun", type: "sofort", title: "Mut zum Becher",
      text: "Du darfst jetzt dein Glas exen. Tust du es, bist du eine Runde lang vor dem Dienen sicher.",
      editions: ["koenige", "rapunzel"] },
    ...
    { id: "s_wiederkehr", type: "sofort", title: "Aus der Geschichte",
      ...
      editions: ["koenige", "rapunzel"] },
    { id: "s_echo_letzte", type: "sofort", title: "Echo", effect: "echo",
    ...
    { id: "r_knabe", type: "regel", title: "Der Knabe",
      text: "Die jüngste Person ist zwei Runden lang der Knabe und wird nur noch „Knabe“ gerufen. Verstoß = dienen.",
      editions: ["koenige", "rapunzel"], temp: true, rounds: 2 },
    ...
    { id: "r_echo_wort", type: "regel", title: "Das Echo",
      text: "{P} wiederholt eine Runde lang das letzte Wort jedes Satzes. Vergessen = dienen. Ein neuer Zug löst den alten ab.",
      editions: ["koenige", "rapunzel"], copies: 2, temp: true },
    { id: "r_hose", type: "regel", title: "In meiner Hose",
      text: "{P} beendet eine Runde lang jeden Satz mit „… in meiner Hose“. Vergessen = dienen. Ein neuer Zug löst den alten ab.",
      editions: ["koenige", "rapunzel"], copies: 2, temp: true },
    ...
    { id: "r_erhebung", type: "regel", title: "Die Erhebung",
      text: "Zwei Runden lang gilt: Erhebt sich {P} von der Tafel, erhebt sich mit Applaus der ganze Hof. Wer nicht klatscht, dient. Ein neuer Zug löst den alten ab.",
      editions: ["koenige", "rapunzel"], copies: 2, temp: true, rounds: 2 },
    { id: "r_artikel", type: "regel", title: "Verbotene Artikel",
      text: "Die Wörter „der“, „die“ und „das“ sind zwei Runden lang verbannt. Verstoß = dienen.",
      editions: ["koenige", "rapunzel"], temp: true, rounds: 2, noEarlyDraw: true },
    ...
    { id: "r_zeitlupe", type: "regel", title: "In Zeitlupe",
      text: "{P} dient eine Runde lang in Zeitlupe.", editions: ["koenige", "rapunzel"], temp: true },
    { id: "r_tafelschlag", type: "regel", title: "Der Tafelschlag",
      text: "Eine Runde lang wird vor jedem Dienst zweimal auf die Tafel geklopft. Vergessen = noch einmal dienen.",
      editions: ["koenige", "rapunzel"], temp: true },
    { id: "r_freibrief", type: "regel", title: "Narrenfreiheit",
      text: "{P} genießt Narrenfreiheit: eine Runde lang von allen Hofgesetzen befreit.",
      editions: ["koenige", "rapunzel"], temp: true },
    { id: "r_inquisitor", type: "regel", title: "Der Inquisitor",
      text: "{P} ist zwei Runden lang der Inquisitor. Wer eine seiner Fragen beantwortet, dient. Ein neuer Inquisitor löst den alten ab.",
      editions: ["koenige", "rapunzel"], copies: 2, temp: true, rounds: 2 },
    { id: "r_schwachehand", type: "regel", title: "Die schwache Hand",
      text: "Eine Runde lang wird nur mit der schwachen Hand gedient. Verstoß = dienen.",
      editions: ["koenige", "rapunzel"], temp: true },
    { id: "r_etikette", type: "regel", title: "Höfische Etikette",
      text: "Eine Runde lang: keine Ellenbogen auf der Tafel. Verstoß = dienen.",
      editions: ["koenige", "rapunzel"], temp: true },
    { id: "r_austritt", type: "regel", title: "Das Austrittsgesuch",
      text: "Zwei Runden lang gilt: Wer die Tafel verlassen will, bittet zuvor förmlich um Erlaubnis der Runde. Sonst dienen.",
      editions: ["koenige", "rapunzel"], temp: true, rounds: 2 },
  ...
  var DECK_EN = [
    ...
    { id: "s_thronwechsel", type: "sofort", title: "The Change of Throne",
      text: "{P} swaps seats with a person of choice. Whoever must yield the seat serves as consolation.",
      editions: ["koenige", "rapunzel"] },
    ...
    { id: "r_anrede", type: "regel", title: "Courtly Address",
      text: "For one round, the whole court addresses one another formally. Breach = serve.", editions: ["koenige", "rapunzel"], temp: true },
    ...
    { id: "s_ex_immun", type: "sofort", title: "Courage to the Cup",
      text: "You may down your glass now. If you do, you are safe from serving for one round.",
      editions: ["koenige", "rapunzel"] },
    ...
    { id: "r_knabe", type: "regel", title: "The Boy",
      text: "The youngest person is the Boy for two rounds and is called nothing but „Boy“. Breach = serve.",
      editions: ["koenige", "rapunzel"], temp: true, rounds: 2 },
    ...
    { id: "r_echo_wort", type: "regel", title: "The Echo",
      text: "{P} repeats the last word of every sentence for one round. Forgetting = serve. A new draw supersedes the old.",
      editions: ["koenige", "rapunzel"], copies: 2, temp: true },
    { id: "r_hose", type: "regel", title: "In My Trousers",
      text: "{P} ends every sentence with „… in my trousers“ for one round. Forgetting = serve. A new draw supersedes the old.",
      editions: ["koenige", "rapunzel"], copies: 2, temp: true },
    ...
    { id: "r_erhebung", type: "regel", title: "The Rising",
      text: "For two rounds: whenever {P} rises from the table, the whole court rises with applause. Whoever doesn't clap serves. A new draw supersedes the old.",
      editions: ["koenige", "rapunzel"], copies: 2, temp: true, rounds: 2 },
    { id: "r_artikel", type: "regel", title: "Forbidden Articles",
      text: "The words „the“, „a“ and „an“ are banished for two rounds. Breach = serve.",
      editions: ["koenige", "rapunzel"], temp: true, rounds: 2, noEarlyDraw: true },
    ...
    { id: "r_zeitlupe", type: "regel", title: "In Slow Motion",
      text: "{P} serves in slow motion for one round.", editions: ["koenige", "rapunzel"], temp: true },
    { id: "r_tafelschlag", type: "regel", title: "The Table Knock",
      text: "For one round, the table is knocked twice before every service. Forgetting = serve once more.",
      editions: ["koenige", "rapunzel"], temp: true },
    { id: "r_freibrief", type: "regel", title: "The Fool's Licence",
      text: "{P} enjoys a fool's licence: exempt from all standing rules for one round.",
      editions: ["koenige", "rapunzel"], temp: true },
    { id: "r_inquisitor", type: "regel", title: "The Inquisitor",
      text: "{P} is the Inquisitor for two rounds. Whoever answers one of their questions serves. A new Inquisitor relieves the old.",
      editions: ["koenige", "rapunzel"], copies: 2, temp: true, rounds: 2 },
    { id: "r_schwachehand", type: "regel", title: "The Weak Hand",
      text: "For one round, one serves only with the weak hand. Breach = serve.",
      editions: ["koenige", "rapunzel"], temp: true },
    { id: "r_etikette", type: "regel", title: "Courtly Etiquette",
      text: "For one round: no elbows on the table. Breach = serve.",
      editions: ["koenige", "rapunzel"], temp: true },
    { id: "r_austritt", type: "regel", title: "The Leave of Absence",
      text: "For two rounds: whoever wishes to leave the table must first formally ask the court's leave. Otherwise serve.",
      editions: ["koenige", "rapunzel"], temp: true, rounds: 2 },
