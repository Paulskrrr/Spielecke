...
(function (global) {
  ...
  var DECK_DE = [
    ...
    { id: "s_obolus", type: "sofort", title: "Der Obolus",
      ...
      editions: ["koenige", "rapunzel"] },
    { id: "s_dreifachzug", type: "sofort", title: "Dreifacher Zug", effect: "extraTurn", extraDraws: 3,
  ...
  var DECK_EN = [
    ...
    { id: "a_sanduhr", type: "aktiv", title: "The Hourglass", power: "sanduhr",
      text: "Secretly set a time limit. When it runs out, whoever is speaking serves.",
      editions: ["koenige", "rapunzel"] },
    ...
    { id: "s_obolus", type: "sofort", title: "The Obol",
      ...
      editions: ["koenige", "rapunzel"] },
    { id: "s_dreifachzug", type: "sofort", title: "Threefold Turn", effect: "extraTurn", extraDraws: 3,
    ...
    { id: "r_augen", type: "regel", title: "The Lowered Gaze",
      text: "No one may look {P} in the eyes any longer. The first three who do anyway serve.",
      editions: ["koenige", "rapunzel"] },
    { id: "r_spitzname", type: "regel", title: "The Nickname",
      text: "The right-hand neighbour gives {P} a nickname. Henceforth only this name applies — it trumps even the ground laws. Breach = serve.",
      editions: ["koenige", "rapunzel"] },
    ...
    { id: "r_echo_wort", type: "regel", title: "The Echo",
      text: "{P} henceforth repeats the last word of every sentence. Forgetting = serve.",
      editions: ["koenige", "rapunzel"] },
