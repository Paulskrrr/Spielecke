...
(function (global) {
  ...
  var DECK_DE = [
    ...
    { id: "r_augen", type: "regel", title: "Der gesenkte Blick",
      text: "Niemand darf {P} in die Augen sehen. Die ersten drei, die es doch tun, dienen — dann ist der Bann gebrochen.",
    ...
    { id: "r_zeitlupe", type: "regel", title: "In Zeitlupe",
      text: "{P} dient die nächsten drei Male in Zeitlupe.", editions: ["koenige", "rapunzel"], temp: true },
  ...
  var DECK_EN = [
    ...
    { id: "r_augen", type: "regel", title: "The Lowered Gaze",
      text: "No one may look {P} in the eyes. The first three who do anyway serve — then the spell is broken.",
      editions: ["koenige", "rapunzel"], copies: 2, temp: true },
    ...
    { id: "r_zeitlupe", type: "regel", title: "In Slow Motion",
      text: "{P} serves the next three times in slow motion.", editions: ["koenige", "rapunzel"], temp: true },
