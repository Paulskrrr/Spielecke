...
(function (global) {
  ...
  var DECK_DE = [
    ...
    { id: "r_tafelschlag", type: "regel", title: "Der Tafelschlag",
      text: "Bis zum Ende dieser Runde wird vor jedem Dienst zweimal auf die Tafel geklopft. Vergessen = noch einmal dienen.",
      editions: ["koenige", "rapunzel"], temp: true },
    { id: "r_freibrief", type: "regel", title: "Der Freibrief",
      text: "{P} ist bis zum Ende dieser Runde von sämtlichen Hofgesetzen befreit.",
      editions: ["koenige", "rapunzel"], temp: true },
  ...
  var DECK_EN = [
    ...
    { id: "r_tafelschlag", type: "regel", title: "The Table Knock",
      text: "Until the end of this round, the table is knocked twice before every service. Forgetting = serve once more.",
      editions: ["koenige", "rapunzel"], temp: true },
    { id: "r_freibrief", type: "regel", title: "The Letter of Freedom",
      text: "{P} is exempt from all standing rules until the end of this round.",
      editions: ["koenige", "rapunzel"], temp: true },
