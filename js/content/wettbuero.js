    ...
    de: {
      kopf: {
        ...
        challenges: [
          ...
          { text: "Nenne die letzten fünf Leute, mit denen du geschrieben hast – in der richtigen Reihenfolge" },
      ...
      geschick: {
        ...
        challenges: [
          ...
          { text: "Trink ein halbes Glas mit einem Strohhalm in unter 10 Sekunden leer", timer: 10 },
          ...
          { text: "Wirf ein Feuerzeug hoch und fang es hinter deinem Rücken – 3 Versuche" },
          { text: "Roll eine Münze einmal komplett über deine Fingerknöchel" },
          { text: "Zwinker fünfmal abwechselnd mit dem linken und rechten Auge – ohne Fehler" },
        ],
      },
      ...
      mut: {
        ...
        challenges: [
          ...
          { text: "Ruf jemanden aus deinen Kontakten an und sing 10 Sekunden lang", timer: 30 },
          ...
          { text: "Mach 10 Liegestütze am Stück", timer: 20 },
          { text: "Lies deine letzte gesendete Nachricht laut vor" },
          ...
          { text: "Lass den Tisch dein Handy 10 Sekunden durchscrollen – ohne zuzuschauen" },
          { text: "Ruf deinen Schwarm oder Ex an und frag nach der Uhrzeit – bleib dabei todernst" },
      ...
      nsfw: {
        ...
        challenges: [
          ...
          { text: "Lies deine letzte Sprachnachricht in verführerischer Stimme vor" },
    ...
    en: {
      kopf: {
        ...
        challenges: [
          ...
          { text: "Name the last five people you texted – in the right order" },
      ...
      geschick: {
        ...
        challenges: [
          ...
          { text: "Finish half a glass through a straw in under 10 seconds", timer: 10 },
          ...
          { text: "Throw a lighter up and catch it behind your back – 3 attempts" },
          { text: "Roll a coin all the way across your knuckles once" },
          { text: "Wink five times, alternating left and right eye – no mistakes" },
        ],
      },
      ...
      mut: {
        ...
        challenges: [
          ...
          { text: "Call someone from your contacts and sing for 10 seconds", timer: 30 },
          ...
          { text: "Do 10 push-ups in a row", timer: 20 },
          ...
          { text: "Let the table scroll through your phone for 10 seconds – without watching" },
          { text: "Call your crush or ex and ask them the time – keep a completely straight face" },
      ...
      nsfw: {
        ...
        challenges: [
          ...
          { text: "Read your last voice message out loud in a seductive voice" },
